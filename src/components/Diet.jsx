...
export default function Diet()
{
    ...
    useEffect(()=>{
        ...
        fetch(`http://localhost:3000/track/${loggedData.loggedUser.userid}/${date.getMonth()+1}-${date.getDate()}-${date.getFullYear()}`,{
            method:"GET",
            headers:{
                    ...
                    items.map((item)=>{
                        ...
                        return (
                            <div className="item" key={item._id}>
                                ...
                                <p>Protein {item.details.protein}g, Carbs {item.details.carbohydreates}g, Fats {item.details.fat}g, Fiber {item.details.fiber}g</p>
